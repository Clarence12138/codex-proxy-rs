...
fn billing_should_follow_requested_tier_independently_of_response_tier() {
    for (requested, actual, expected) in [
        (Some("priority"), Some("default"), Some(4_500_000_000)),
        (Some("fast"), Some("default"), Some(4_500_000_000)),
        (Some("auto"), Some("fast"), None),
        (Some("default"), Some("flex"), Some(1_800_000_000)),
        (Some("flex"), Some("priority"), Some(900_000_000)),
        (Some("fast"), None, Some(4_500_000_000)),
        (Some("auto"), None, None),
        (Some("default"), Some("future"), Some(1_800_000_000)),
        (Some("future"), Some("default"), None),
        (None, Some("priority"), Some(1_800_000_000)),
        (None, None, Some(1_800_000_000)),
    ] {
        assert_eq!(
